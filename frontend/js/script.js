var todoApiEndpoint =
  "https://j3cv37qhud.execute-api.us-east-1.amazonaws.com/dev/";
var todoFilesApiEndpoint =
  "https://4oumdscha7.execute-api.us-east-1.amazonaws.com/dev/";
var cognitoUserPoolId = "ca-central-1_tcKK4ZZD2";
...
function deleteTodoFile(todoID, fileID, filePath, callback) {
  try {
    var todoFilesApi =
      todoFilesApiEndpoint + todoID + "/files/" + fileID + "/delete";
    var sessionTokensString = localStorage.getItem("sessionTokens");
    var sessionTokens = JSON.parse(sessionTokensString);
    var IdToken = sessionTokens.IdToken;
    var idJwt = IdToken.jwtToken;
